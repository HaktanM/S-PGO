...
if __name__ == "__main__":
    ...
    #     # Extract scalar values safely
    #     anchor_idx = map_value_to_index(v=idx, x=manager.optimizer.number_of_landmarks, n=manager.optimizer.number_of_keyframes)
    #     actual_inv_depth = manager.simulator.actual_depths[anchor_idx][idx][False]
    #     manager.optimizer.estimated_inverse_depths[idx] = actual_inv_depth
